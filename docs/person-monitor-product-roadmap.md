...
**Базова точка:** блок 4.5 «Перевірка повного тексту медіаматеріалів» закрито; наступний запланований блок — 4.6 «Класифікація ролі суб’єкта в корупційному матеріалі».  
**Технічний стан:** 526/526 тестів пройдено; останній коміт на момент фіксації — `7188593 improve full text article compatibility`.
...
| 20 | Пул новин пов’язаних із суб’єктом | 🟡 Сильно просунуто | Google Web/News, corruption gate, identity gate, full-text verification готові. Далі — класифікація ролі суб’єкта та фінальне збереження/представлення. |
...
Не підключати нові великі джерела одразу. Оптимальна послідовність: **4.6 → unified dossier orchestrator → фінальна структура аналітичної довідки → evidence/manual review/versioning → після цього AUTO.RIA / нерухомість / OpenDataBot.**
